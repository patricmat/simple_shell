...
/**
 * add_node_end - at the end of the list adds a node
 * @head: address points to head node
 * @str: str field of node
 * @num: node index used by history
 *
 * Return: list size
...
/**
 * delete_node_at_index - deletes node at certain index
 * @head: address points to first node
